...
SCHEMA_SQL = """\
-- Stele documentation schema
-- Generated by: stele init-db
...
def get_init_sql(config: SteleConfig) -> str:
    ...
    title, content, etc.). STELE_COL_* overrides are for querying existing
